  ...
  return (
    <div id="team-showcase" class="flex flex-col items-center gap-8 md:gap-12">
      <div class="w-full max-w-xl px-4">
        <button class="mb-4 ml-auto flex items-center gap-2 focus:text-primary after:content-['✓'] after:text-primary after:transition after:ease-out after:duration-200 after:opacity-0 active:after:opacity-100" hx-on:click="navigator?.clipboard?.writeText(document?.location?.href); console.log('Copied')">
